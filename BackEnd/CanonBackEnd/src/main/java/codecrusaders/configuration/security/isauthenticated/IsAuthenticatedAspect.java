package codecrusaders.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(codecrusaders.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(codecrusaders.configuration.security.isauthenticated.IsAuthenticated)")
